...
import org.jmagic.actions.rules.game.TurnIs;
import org.jmagic.actions.rules.game.TurnStepIs;
import org.jmagic.actions.rules.players.CardsDrawnCountReflectsMulliganCount;
import org.jmagic.actions.rules.players.HasNotAlreadyInitiallyDrawnMoreThan;
 ...
 * @author ldavid
 */
public final class InitialDraw extends Action {
    ...
    public State update(State state) {
        ...
        List<State.PlayerState> ps = new ArrayList<>(state.playerStates());
