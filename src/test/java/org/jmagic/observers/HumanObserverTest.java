...
class HumanObserverTest {
    ...
    void afterPlayerAct() {
        ...
        State actual = o.afterPlayerAct(INITIAL_STATE, new AdvanceGame(), STARTED_AT, STARTED_AT + 990);
        ...
        actual = o.afterPlayerAct(INITIAL_STATE, new Draw(), STARTED_AT, STARTED_AT + 990);
